...
macro(dr_evt_check_and_append_flag MY_VAR)
  foreach(flag ${ARGN})
...
dr_evt_check_and_append_flag(CMAKE_CXX_FLAGS
  ...
  -Wno-deprecated-declarations ${COMPILER_OPT_FOR_GPROF} ${USER_FLAGS})
...
dr_evt_check_and_append_flag(CMAKE_CXX_FLAGS_DEBUG -O0)

if (${UPPER_PROJECT_NAME}_WARNINGS_AS_ERRORS)
  dr_evt_check_and_append_flag(_WERROR_FLAGS -Werror)
  separate_arguments(_WERROR_FLAGS NATIVE_COMMAND "${_WERROR_FLAGS}")
  if (NOT TARGET DR_EVT_CXX_FLAGS_werror)
    add_library(DR_EVT_CXX_FLAGS_werror INTERFACE)
    set_property(TARGET DR_EVT_CXX_FLAGS_werror PROPERTY
      INTERFACE_COMPILE_OPTIONS $<$<COMPILE_LANGUAGE:CXX>:${_WERROR_FLAGS}>)

    # Add the "library" to the export
    install(TARGETS DR_EVT_CXX_FLAGS_werror EXPORT DR_EVT_Targets)
  endif ()
endif ()
...
if (CMAKE_CXX_COMPILER_ID MATCHES "Clang")
  if (USE_CLANG_LIBCXX)
    dr_evt_check_and_append_flag(CMAKE_CXX_FLAGS "--stdlib=libc++")
  ...
  if (CMAKE_BUILD_TYPE MATCHES Debug)
    ...
    dr_evt_check_and_append_flag(CMAKE_CXX_FLAGS -fno-omit-frame-pointer)
  endif ()
endif ()
...
if (DR_EVT_WITH_OPENMP)
  find_package(OpenMP REQUIRED)
endif (DR_EVT_WITH_OPENMP)
